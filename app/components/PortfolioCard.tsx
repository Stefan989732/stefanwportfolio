...
export default function PortfolioCard() {
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 justify-center mb-8">
            {/* <p>to do:</p>
            <ul>
                <ul>
                    <li>- probleem</li>
            ...
            <p className="flex justify-center text-6xl text-[var(--detail)] gap-2 pt-8 col-span-full">Overige Projecten</p>
            <p className="flex justify-center text-2xl text-[var(--detail)] gap-2 pb-8 col-span-full">Dit zijn mijn beste projecten</p>
